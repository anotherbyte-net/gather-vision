...
class EnergexImport:
    def __init__(
        ...
        self._source = app_models.InformationSource.objects.get(name=EnergexEvents.code)
    ...
    def import_outages(self, path: Path) -> None:
        ...
        for table_name in table_names:
            for row in db.get_table_data(conn, table_name):
                ...
                if self.is_demand(data):
                    ...
                    raise ValueError(f"Unrecognised data format: '{data}'.")
