...
from gather_vision.process.service.abstract import (
    AuthRequiredService,
    PlaylistSource,
    PlaylistTarget,
)
...
class Spotify(AuthRequiredService, PlaylistSource, PlaylistTarget):
    service_name = "spotify"
    service_title = "Spotify"
    ...
    def search_tracks(
        ...
        self._logger.info(
            f"Looking for Spotify track matching track '{track}' artists '{artists}'."
        )
