    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, help_text='The date this item was created.')),
                ('modified_date', models.DateTimeField(auto_now=True, help_text='The date this item was last changed.')),
                ('name', models.CharField(help_text='The name of the petition source.', max_length=50, unique=True)),
                ('title', models.CharField(help_text='The displayed title of the petition source.', max_length=100)),
                ('info_url', models.URLField(blank=True, help_text='A link to information about the petition source.')),
            ],
            options={
                'ordering': ['modified_date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, help_text='The date this item was created.')),
                ('modified_date', models.DateTimeField(auto_now=True, help_text='The date this item was last changed.')),
                ('name', models.CharField(help_text='The name of the playlist source.', max_length=50, unique=True)),
                ('title', models.CharField(help_text='The displayed title of the playlist source.', max_length=100)),
                ('info_url', models.URLField(blank=True, help_text='A link to information about the playlist source.')),
            ],
            options={
                'ordering': ['modified_date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, help_text='The date this item was created.')),
                ('modified_date', models.DateTimeField(auto_now=True, help_text='The date this item was last changed.')),
                ('name', models.SlugField(help_text='The name of the transport notices source.', unique=True)),
                ('title', models.CharField(help_text='The displayed title of the transport notices source.', max_length=100)),
                ('info_url', models.URLField(blank=True, help_text='A link to information about the transport notices source.')),
            ],
            options={
                'ordering': ['modified_date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notices', to='gather_vision.transportsource')),
            ],
            options={
                'ordering': ['modified_date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='playlists', to='gather_vision.playlistsource')),
            ],
            options={
                'ordering': ['modified_date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='petitions', to='gather_vision.petitionsource')),
            ],
        ),
        migrations.CreateModel(
            name='PetitionChange',
