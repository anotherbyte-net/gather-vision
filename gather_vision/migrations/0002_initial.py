    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_updated_date', models.DateTimeField(blank=True, help_text='The date the outage info was last updated by the source.', null=True)),
                ('demand', models.PositiveIntegerField(help_text='The amount of demand.')),
                ('rating', models.PositiveIntegerField(help_text='The rating of the demand level.')),
                ('total_customers', models.PositiveIntegerField(help_text='The total number of customers affected.')),
            ],
            options={
                'ordering': ['modified_date'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, help_text='The date this item was created.')),
                ('modified_date', models.DateTimeField(auto_now=True, help_text='The date this item was last changed.')),
                ('source_identifier', models.CharField(help_text='The identifier for this transport notice from the source.', max_length=200)),
                ('title', models.CharField(help_text='The title of the transport notice.', max_length=200)),
                ('body', models.TextField(blank=True, help_text='The text of the transport notice.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracks', to='gather_vision.informationsource')),
            ],
        ),
        migrations.CreateModel(
            name='PlaylistItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, help_text='The date this item was created.')),
                ('modified_date', models.DateTimeField(auto_now=True, help_text='The date this item was last changed.')),
                ('event_name', models.CharField(blank=True, help_text='The name of the outage event.', max_length=500)),
                ...
                ('post_code', models.CharField(blank=True, help_text='The location post code.', max_length=4)),
                ('cause', models.CharField(help_text='The cause of the outage.', max_length=500)),
                ('streets', models.CharField(blank=True, help_text='The name of the streets involved in the outage.', max_length=400)),
                ('restored_date', models.DateTimeField(blank=True, help_text='The date this outage ended.', null=True)),
                ('customers', models.PositiveIntegerField(help_text='The number of customers affected.')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outages', to='gather_vision.outagegroup')),
        ...
        migrations.AddConstraint(
            model_name='outageitem',
            constraint=models.UniqueConstraint(fields=('group', 'event_name'), name='outage_item_unique_group_event_name'),
        ),
    ]
