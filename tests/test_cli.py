...
def test_cli_update_example_plugin(capsys, caplog, tmp_path):
    ...
    for index, log_item in [
        ...
        (-7, (l_app, 20, "Loaded 2 data items from web data sources.")),
        (-6, (l_app, 20, "Finished update.")),
        (-5, (l_cli, 20, "Updated 1 local data items.")),
        (-4, (l_cli, 20, prefix + "2' with 2 items")),
        (-3, (l_cli, 20, "Updated 1 web data items.")),
        (-2, (l_cli, 20, prefix + "1' with 2 items")),
        (-1, (l_cli, 20, "Finished.")),
    ]:
